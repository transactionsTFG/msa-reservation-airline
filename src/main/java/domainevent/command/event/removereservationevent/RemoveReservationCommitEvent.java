...
public class RemoveReservationCommitEvent extends BaseHandler {
    ...
    public void commandPublisher(String json) {
        ...
        if (this.reservationServices.validateSagaId(c.getIdReservation(), eventData.getSagaId()) && this.reservationLineServices.validateSagaId(c.getListIdFlightInstance(), c.getIdReservation(), eventData.getSagaId())) 
